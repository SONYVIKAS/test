...
public class PDFDataExtractionTool {
    ...
    public static void main(String[] args) {
        // Simulate user input for genre selection
        ...
        if (genre.equals("visawaale")) {
            ...
            List<File> uploadedFiles = Arrays.asList(new File("file1.pdf"), new File("file2.pdf")); // Example files
            ...
            if (!uploadedFiles.isEmpty()) {
                ...
                try {
                    ...
                    for (Map<String, String> data : allInvoiceDetails) {
                        printer.printRecord(data.values());
                    }
                    printer.flush();
                    printer.close();
    ...
    // Dummy function to convert words to numbers
    private static int wordToNumber(String words) {
        // Implement a word to number conversion logic
