...
class BinarySearchTree {
    ...
    static boolean isBSTRecursive(Node root, Integer smallest, Integer largest) {
        if (root == null) {
            return true;
        }
...
public class Tests {
    ...
    public void testIsBST() {
        assertFalse(BinarySearchTree.isBST(createBST1()));
        assertTrue(BinarySearchTree.isBST(createBST2()));
    }